...
const ContactUs = () => {
  return (
    <section className="cs-page_head cs-bg">
      <div className="animate__animated animate__fadeInUp speed">
              ...
              <div className="col-lg-8 offset-lg-2">
                <div className="cs-contact_card_wrap">
                  <div className="cs-contact_card">
                    <div className="cs-contact_info shadow text-center">
                      ...
                      <p className="cs-contact_text">+1 (903) 208-8240</p>
                    </div>
                    <div className="cs-contact_info shadow text-center">
                      <div className="cs-contact_icon">
                        <svg
                      ...
                      <p className="cs-contact_text">example@example.com</p>
                    </div>
                    <div className="cs-contact_info shadow text-center">
                      <div className="cs-contact_icon">
                        <svg
